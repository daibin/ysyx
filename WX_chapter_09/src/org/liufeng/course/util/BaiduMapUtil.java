...
public class BaiduMapUtil {
	...
	public static UserLocation convertCoord(String lng, String lat) {
		...
		try {
			...
			float bd09lng=Float.parseFloat(Base64.decode(jsonObject.getString("x"), "UTF-8"))+0.0053f;
			float bd09lat=Float.parseFloat(Base64.decode(jsonObject.getString("y"), "UTF-8"))-0.0026f;
			location.setBd09Lng(String.valueOf(bd09lng));
			location.setBd09Lat(String.valueOf(bd09lat));
		} catch (Exception e) {
			location = null;
			e.printStackTrace();
		}
