...
public class VlcVideoActivity extends Activity implements SurfaceHolder.Callback, IVideoPlayer {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String rtspUrl="rtsp://11.115.247.134:8989/service?PuId-ChannelNo={x}&PlayMethod=0";
		rtspUrl=rtspUrl.replace("{x}", std_id);
		Log.i("rtspUrl", rtspUrl);
		//mMediaPlayer.playMRL("rtsp://11.115.247.134:8989/service?PuId-ChannelNo=42088100001310400947&PlayMethod=0");
		mMediaPlayer.playMRL(rtspUrl);
	}
