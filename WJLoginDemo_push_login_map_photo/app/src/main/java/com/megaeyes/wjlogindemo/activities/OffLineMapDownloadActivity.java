...
public class OffLineMapDownloadActivity extends AppCompatActivity implements MKOfflineMapListener {
    ...
    public class LocalMapAdapter extends BaseAdapter {
        ...
        public View getView(int index, View view, ViewGroup arg2) {
            ...
            view = View.inflate(OffLineMapDownloadActivity.this,
        ...
        void initViewItem(View view, final MKOLUpdateElement e) {
           ...
           display.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.setClass(OffLineMapDownloadActivity.this, ShowOffLineMapActivity.class);
