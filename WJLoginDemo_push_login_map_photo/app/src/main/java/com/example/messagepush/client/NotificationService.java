...
public class NotificationService extends Service {
    ...
    public static final String SERVICE_NAME = "com.example.messagepush.client.NotificationService";
    ...
    public static Intent getIntent() {
        ...
        mIntent.setAction(SERVICE_NAME);//你定义的service的action
        mIntent.setPackage("com.megaeyes.wjlogindemo");//这里你需要设置你应用的包名
        return mIntent;
