...
public class SecondFragment extends Fragment {
    ...
    private void initViews(View view) {
        //progressBar= (ProgressBar) allCasesLayout.findViewById(R.id.progressBar);
        //listView= (ListView) allCasesLayout.findViewById(R.id.lv_all_cases);
