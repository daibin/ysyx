 ...
 */
public class CaseHandledAdapter extends BaseAdapter {

    private static final String TAG = "CaseHandledAdapter";
    private List<CaseInfoView> datas;
    private Context context;
    private LayoutInflater inflater;

    public CaseHandledAdapter() {
    }

    public CaseHandledAdapter(List<CaseInfoView> datas, Context context) {
        this.datas = datas;
