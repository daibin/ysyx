 ...
 */
public class DispatchPoliceAdapter extends BaseAdapter {

    private static final String TAG = "DispatchPoliceAdapter";
    private List<CaseInfoView> datas;
    private Context context;
    private LayoutInflater inflater;

    public DispatchPoliceAdapter() {
    }

    public DispatchPoliceAdapter(List<CaseInfoView> datas, Context context) {
        this.datas = datas;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (caseInfoView.getAjzt()){
            case 1:
                ...
                viewHolder.tv_ajzt_desc.setText("正在处警中");
                break;
            case 2:
            ...
            case 3:
                ...
                viewHolder.tv_ajzt_desc.setText("空闲中");
                break;
            case 4:
